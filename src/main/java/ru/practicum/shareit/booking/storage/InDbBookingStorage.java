...
public class InDbBookingStorage implements BookingStorage {
    ...
    public List<Booking> getAllCurrentBookingsForBooker(Long bookerId) {
        ...
        return bookingRepository.findBookingsByBookerIdAndStartBeforeAndEndAfter(bookerId, LocalDateTime.now(Clock.systemDefaultZone()), LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public List<Booking> getAllPastBookingsForBooker(Long bookerId) {
        ...
        return bookingRepository.findBookingsByBookerIdAndEndBeforeOrderByEndDesc(bookerId, LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public List<Booking> getAllFutureBookingsForBooker(Long bookerId) {
        ...
        return bookingRepository.findBookingsByBookerIdAndStartAfterOrderByStartDesc(bookerId, LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public List<Booking> getAllCurrentBookingsForOwner(Long ownerId) {
        ...
        return bookingRepository.findBookingsByOwnerIdAndStartBeforeAndEndAfterOrderByEndDesc(ownerId, LocalDateTime.now(Clock.systemDefaultZone()), LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public List<Booking> getAllPastBookingsForOwner(Long ownerId) {
        ...
        return bookingRepository.findBookingsByOwnerIdAndEndBeforeOrderByEndDesc(ownerId, LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public List<Booking> getAllFutureBookingsForOwner(Long ownerId) {
        ...
        return bookingRepository.findBookingsByOwnerIdAndStartAfterOrderByIdDesc(ownerId, LocalDateTime.now(Clock.systemDefaultZone()));
    }
    ...
    public Booking getLastBookingForItem(Long itemId) {
        ...
        ArrayList<Booking> bookings = new ArrayList<>(bookingRepository.findBookingsByItemIdAndEndBeforeOrderByEndAsc(itemId, LocalDateTime.now(Clock.systemDefaultZone())));
    ...
    public Booking getNextBookingForItem(Long itemId) {
        ...
        ArrayList<Booking> bookings = new ArrayList<>(bookingRepository.findBookingsByItemIdAndStartAfterAndStatusOrderByStartAsc(itemId, LocalDateTime.now(Clock.systemDefaultZone()), Status.APPROVED));
        if (bookings.isEmpty()) return null;
        return bookings.get(0);
    }
    ...
    public Booking getLastBookingForItemByOwner(Long itemId, Long userId) {
        ...
        List<Booking> bookings = bookingRepository.findBookingsByItemIdAndStartBeforeAndStatusOrderByEndDesc(itemId, LocalDateTime.now(Clock.systemDefaultZone()), Status.APPROVED);
        if (bookings.isEmpty()) return null;
        return bookings.get(0);
    }
    ...
    public Booking getNextBookingForItemByOwner(Long itemId, Long userId) {
        ...
        List<Booking> bookings = bookingRepository.findBookingsByItemIdAndStartAfterAndStatusOrderByStartAsc(itemId, LocalDateTime.now(Clock.systemDefaultZone()), Status.APPROVED);
        if (bookings.isEmpty()) return null;
        return bookings.get(0);
    }
